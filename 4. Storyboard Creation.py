...
Original file is located at
    https://colab.research.google.com/drive/13HBrZ24J7s48lYBRcvcGYbmkGYWfwp_s
"""
...
if not OPENAI_API_KEY or OPENAI_API_KEY.startswith("sk‑paste"):
    raise ValueError("⚠️  Please paste your real OpenAI API key in OPENAI_API_KEY.")
